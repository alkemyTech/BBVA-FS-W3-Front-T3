...
export default function Slider() {
    ...
    return(
        <Grid container
              sx={{ display: "flex", justifyContent: "center", marginTop:"100px",placeItems: "center", alignItems:"center"  }}
            // sx={{ placeItems: "center", marginTop:"100px" }}
        >
            <Grid item xs={3}/>
            <Grid item xs={1} sx={{alignItems:"center",placeItems:"center"}}>
                <IconButton aria-label="delete" sx={{justify:"center"}} onClick={handleBack}>
                    <ArrowBackIcon />
                </IconButton>
            </Grid>

            <Grid item sx={{width:"600px",alignItems:"center",placeItems:"center"}} >
