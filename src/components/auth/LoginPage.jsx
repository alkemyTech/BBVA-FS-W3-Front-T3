...
const LoginPage = () => {
  ...
  return (
    ...
    <img className="img_login_logo"  src="/src/assets/logo-no-background.svg" width="100%" alt="" />
       </JustifyBox>
        ...
        <Grid container sx={{ backgroundColor: '#fff' }}>
          ...
          <LoginTitle>
            ...
            Si no estás registrado, puedes{' '}
              <RegisterLink href="/register">registrarte aquí</RegisterLink>.
              <ImageContainer p={4} height="100%">
              <img src="/src/assets/login_image.jpg" width="100%" alt="" />
            </ImageContainer>
