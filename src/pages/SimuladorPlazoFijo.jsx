...
const PlazoFijo = () => {
  ...
  const onSubmit = (values) => {
    ...
    const mesesFaltantes = (fechaCierre.getFullYear() - fechaActual.getFullYear()) * 12 + (fechaCierre.getMonth() - fechaActual.getMonth());
    ...
    setMessage(`Monto con interés: $${montoConInteres.toFixed(2)}, Meses faltantes para el cierre: ${mesesFaltantes}`);
